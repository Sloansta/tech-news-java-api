...
import come.technews.repository.CommentRepository;
import come.technews.repository.PostRepository;
import come.technews.repository.UserRepository;
import come.technews.repository.VoteRepository;
...
public class TechNewsController {
	...
	public String signup(@ModelAttribute User user, Model model, HttpServletRequest request) throws Exception {
		...
		try {
			...
			model.addAttribute("notice", "Email address is not available! Please enter a different email.");
			return "login";
		}
	...
	public String createCommentCommentsPage(@ModelAttribute Comment comment, Model model, HttpServletRequest request) {
		if(comment.getCommentText().isEmpty() || comment.getId().equals(null)) {
